...
| **Modos de ejecución** | [English](execution-modes.md) · [中文](execution-modes.zh-CN.md) · [Español](execution-modes.es.md) | En proceso, proceso externo, Docker y ejecución remota, y el modelo de seguridad de cada uno |
| **Arquitectura y agentes** | [English](architecture.md) · [中文](architecture.zh-CN.md) · [Español](architecture.es.md) | Cómo funciona ASON, los agentes internos y la comparación detallada con tool calling / MCP |
